...
public class editClientDialog extends javax.swing.JDialog {
    ...
    public editClientDialog(JFrame fram, Clientes principal) {
        super(fram, true);
        this.fram = fram;
    ...
    public void showMessage(String cedula, String nombre, String genero, String telefono, String direccion, String correo) {
        txtCedula.setText(cedula);
        txtNombre.setText(nombre);
        boxGenero.setSelectedItem(genero);
        txtTlf.setText(telefono);
        txtDirection.setText(direccion);
