...
public class DeleteItemVentaDialog extends JDialog {
    ...
    public DeleteItemVentaDialog(JFrame fram) {
        super(fram, true);
        this.fram = fram;
        initComponents();
        init();
    ...
    private void initComponents() {
        ...
        background1Layout.setHorizontalGroup(
            ...
            .addGroup(background1Layout.createSequentialGroup()
                .addComponent(cmdCancel, GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
                .addGap(3, 3, 3)
